...
abstract class ExternalCallFilterAbstract
{
    ...
    public function toDto()
    {
        return self::createDto()
            ...
            ->setHolidayLocution($this->getHolidayLocution() ? $this->getHolidayLocution()->toDto() : null)
            ->setOutOfScheduleLocution($this->getOutOfScheduleLocution() ? $this->getOutOfScheduleLocution()->toDto() : null)
            ->setHolidayExtension($this->getHolidayExtension() ? $this->getHolidayExtension()->toDto() : null)
            ->setOutOfScheduleExtension($this->getOutOfScheduleExtension() ? $this->getOutOfScheduleExtension()->toDto() : null)
            ->setHolidayVoiceMailUser($this->getHolidayVoiceMailUser() ? $this->getHolidayVoiceMailUser()->toDto() : null)
            ->setOutOfScheduleVoiceMailUser($this->getOutOfScheduleVoiceMailUser() ? $this->getOutOfScheduleVoiceMailUser()->toDto() : null)
            ->setHolidayNumberCountry($this->getHolidayNumberCountry() ? $this->getHolidayNumberCountry()->toDto() : null)
            ->setOutOfScheduleNumberCountry($this->getOutOfScheduleNumberCountry() ? $this->getOutOfScheduleNumberCountry()->toDto() : null);
    }
