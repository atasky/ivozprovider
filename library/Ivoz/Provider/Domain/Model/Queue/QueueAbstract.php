...
abstract class QueueAbstract
{
    ...
    public function toDto()
    {
        return self::createDto()
            ...
            ->setPeriodicAnnounceLocution($this->getPeriodicAnnounceLocution() ? $this->getPeriodicAnnounceLocution()->toDto() : null)
            ->setTimeoutLocution($this->getTimeoutLocution() ? $this->getTimeoutLocution()->toDto() : null)
            ->setTimeoutExtension($this->getTimeoutExtension() ? $this->getTimeoutExtension()->toDto() : null)
            ->setTimeoutVoiceMailUser($this->getTimeoutVoiceMailUser() ? $this->getTimeoutVoiceMailUser()->toDto() : null)
            ->setFullLocution($this->getFullLocution() ? $this->getFullLocution()->toDto() : null)
            ->setFullExtension($this->getFullExtension() ? $this->getFullExtension()->toDto() : null)
            ->setFullVoiceMailUser($this->getFullVoiceMailUser() ? $this->getFullVoiceMailUser()->toDto() : null)
            ->setTimeoutNumberCountry($this->getTimeoutNumberCountry() ? $this->getTimeoutNumberCountry()->toDto() : null)
            ->setFullNumberCountry($this->getFullNumberCountry() ? $this->getFullNumberCountry()->toDto() : null);
    }
