...
abstract class UserAbstract
{
    ...
    public function toDto()
    {
        return self::createDto()
            ...
            ->setBossAssistant($this->getBossAssistant() ? $this->getBossAssistant()->toDto() : null)
            ->setBossAssistantWhiteList($this->getBossAssistantWhiteList() ? $this->getBossAssistantWhiteList()->toDto() : null)
            ...
            ->setVoicemailLocution($this->getVoicemailLocution() ? $this->getVoicemailLocution()->toDto() : null);
    }
