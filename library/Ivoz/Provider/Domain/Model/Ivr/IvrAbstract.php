...
abstract class IvrAbstract
{
    ...
    public function toDto()
    {
        return self::createDto()
            ...
            ->setNoInputLocution($this->getNoInputLocution() ? $this->getNoInputLocution()->toDto() : null)
            ->setErrorLocution($this->getErrorLocution() ? $this->getErrorLocution()->toDto() : null)
            ->setSuccessLocution($this->getSuccessLocution() ? $this->getSuccessLocution()->toDto() : null)
            ->setNoInputExtension($this->getNoInputExtension() ? $this->getNoInputExtension()->toDto() : null)
            ->setErrorExtension($this->getErrorExtension() ? $this->getErrorExtension()->toDto() : null)
            ->setNoInputVoiceMailUser($this->getNoInputVoiceMailUser() ? $this->getNoInputVoiceMailUser()->toDto() : null)
            ->setErrorVoiceMailUser($this->getErrorVoiceMailUser() ? $this->getErrorVoiceMailUser()->toDto() : null)
            ->setNoInputNumberCountry($this->getNoInputNumberCountry() ? $this->getNoInputNumberCountry()->toDto() : null)
            ->setErrorNumberCountry($this->getErrorNumberCountry() ? $this->getErrorNumberCountry()->toDto() : null);
    }
